function [A, B] = MultiSlope(M,flood)

% [A, B] = MultiSlope(M,flood)
% 
% Computes upslope contributing area using the Multi-Slope
% algorithm
% 
%      Input arguments:
...
% Copyright (C) 2004-2012 Taylor Perron <perron@mit.edu>
% 
...
if (nargin < 1 || nargin > 2 || nargout > 2), help(mfilename), return, end
...
[A, B] = mexMultiSlope(M.grid,M.dy/M.dx,flood,ndv);
